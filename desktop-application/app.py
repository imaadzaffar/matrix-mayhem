...
class statusLabel(textLabel):
    ...
    def setStatus(self):
        ...
        self.statusWrap = textwrap.fill(self.textString, width = 5)
        
        self.statusLabel = Label(text = "{}".format(self.textString), font=("Impact", self.textSize), fg = self.textColour, relief =  GROOVE)
...
class MainApplication:
    ...
    def loginWidgets(self):
        ...
        usernameLabel = textLabel("👨‍🚀 Username", 619, 300, 'black', 35)
        usernameLabel.placeText()
        
        self.usernameEntry = Entry(font=("Impact", 25))
        self.usernameEntry.place(x=565, y=360)

        passwordLabel = textLabel("🔑 Password", 620, 450, 'black', 35)
        ...
        if len(registerUser) >= 4 and len(registerPass) >= 8:
            ...
            if registerResults:
                ...
                try:
                    ...
                    pass
                self.statusLabel = statusLabel("Username is taken. Please select another.", 405, 570, 'red', 35)
                ...
                try:
                    ...
                    pass
                self.statusLabel = statusLabel("Your account has been successfully registered.", 370, 570, 'green', 35)
                self.statusLabel.setStatus()
            ...
            try:
                ...
                pass
            self.statusLabel = statusLabel("Username needs to be greater then 4, and password greater then 8 characters.", 150, 570, 'red', 35)
            self.statusLabel.setStatus()
    ...
    def loginFunction(self):
        ...
        if loginResults:
            ...
            try:
                ...
                pass
            self.statusLabel = statusLabel("Error, account does not exist.", 490, 570, 'red', 35)
            self.statusLabel.setStatus()
    ...
    def teacherModule(self):
        ...
        questionText = textLabel("❓Add a question", 365, 150, 'black', 100)
        questionText.placeText()

        addButton = interactiveButton("➕ Addition", self.createAddition, 100, 600, 50)
        addButton.createButton()

        multButton = interactiveButton("✖️ Multiplication", self.createMultiplication, 475, 600, 50)
        multButton.createButton()

        detButton = interactiveButton("◼️ Determinant", self.createDeterminant, 950,600, 50)
    ...
    def createAddition(self):
        ...
        submitButton = interactiveButton("✏️ Create Question", self.addAdd, 500, 605, 50)
    ...
    def createMultiplication(self):
        ...
        submitButton = interactiveButton("✏️ Create Question", self.addMult, 500, 605, 50)
        submitButton.createButton()
    ...
    def createDeterminant(self):
        ...
        submitButton = interactiveButton("✏️ Create Question", self.addDet, 500, 605, 50)
        submitButton.createButton()
