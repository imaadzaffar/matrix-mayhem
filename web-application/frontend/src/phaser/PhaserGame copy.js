...
function create() {
  planets = ["wet_animate", "dry_animate", "moon_animate", "lava_animate"];
  hazards = ["black_animate", "galaxy_animate", "star_animate"];
  asteroids = [
    "asteroid1",
    "asteroid2",
    "asteroid3",
  ...
  // button = this.add.image(100, 100, 'button').setScale(0.2)
  // button.depth = 5
  // button.setInteractive();

  // button.on('pointerdown', () => {mayhem.game_state = 2})
}
